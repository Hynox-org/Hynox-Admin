...
export default function InvoicesPage() {
    ...
    useEffect(() => {
        const fetchInvoices = () => __awaiter(this, void 0, void 0, function* () {
            const invoices = yield listInvoices();
            setRows(invoices);
        });
        fetchInvoices();
    }, []);
          ...
          <Table>
            ...
            <TableBody>
              {rows.length === 0 ? (<TableRow>
                ...
                </TableRow>) : (rows.map((inv) => {
            var _a;
            return (<TableRow key={inv.id}>
                    <TableCell>{inv.number}</TableCell>
                    <TableCell>{((_a = inv.to) === null || _a === void 0 ? void 0 : _a.name) || "-"}</TableCell>
                    <TableCell>
                      {new Intl.NumberFormat(undefined, { style: "currency", currency: inv.currency }).format(inv.total)}
                    </TableCell>
