...
import { saveInvoice, getCompany, getDefaultTax, getDefaultCurrency, saveDefaultCurrency, saveDefaultTax } from "@/lib/storage";
...
export default function InvoiceForm() {
    ...
    return (<div className="space-y-6">
      ...
      <Card className="bg-card">
        ...
        <CardContent>
          <Textarea value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="Payment terms or additional notes"/>
        </CardContent>
      </Card>
